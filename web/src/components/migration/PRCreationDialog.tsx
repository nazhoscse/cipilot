...
This migration was generated using [CIPilot](https://cipilot.com), a research tool that uses an agentic AI system powered by Large Language Models (LLMs) to automate CI/CD migration.

CIPilot analyzed your existing configuration and converted it to an equivalent GitHub Actions workflow. The AI agents validate the generated output through automated syntax and schema checking, iteratively refining it based on feedback.
...
*Generated by [CIPilot](https://cipilot.com) — Agentic AI for CI/CD migration*`
  )
